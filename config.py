...
COUNTRIES = {
    ...
    "argentina": {
        ...
        "flag": "🇦🇷",
        "regions": {
            "all": {"name": "🍷 Все регионы Аргентины", "file": "argentina.json"},
        },
        "random_label": "🎲 Случайно по Аргентине"
    },
    "australia": {
        "name": "🇦🇺 Австралия",
        "flag": "🇦🇺",
        "regions": {
            "all": {"name": "🍷 Все регионы Австралии", "file": "australia.json"},
        },
        "random_label": "🎲 Случайно по Австралии"
    },
    "chile": {
        "name": "🇨🇱 Чили",
        "flag": "🇨🇱",
        "regions": {
            "all": {"name": "🍷 Все регионы Чили", "file": "chile_questions.json"},
        },
        "random_label": "🎲 Случайно по Чили"
    },
    "south_africa": {
        "name": "🇿🇦 ЮАР",
        "flag": "🇿🇦",
        "regions": {
            "all": {"name": "🍷 Все регионы ЮАР", "file": "south_africa.json"},
        },
        "random_label": "🎲 Случайно по ЮАР"
    },
    "usa": {
        "name": "🇺🇸 США",
        "flag": "🇺🇸",
